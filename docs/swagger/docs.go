...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/zpwoot_internal_services.ListMessagesResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/zpwoot_internal_services.CreateMessageResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/sessions/{sessionId}/messages/stats": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/zpwoot_internal_core_messaging.MessageStats"
                                        }
                                    }
                                }
                            ]
        ...
        "/sessions/{sessionId}/messages/{messageId}/sync": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Sync status update request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/UpdateSyncStatusRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "zpwoot_internal_services.CreateMessageResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "zpwoot_internal_services.ListMessagesResponse": {
            "type": "object",
            "properties": {
                "limit": {
                    "type": "integer"
