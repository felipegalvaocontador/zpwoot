...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_adapters_server_handler.ChatwootWebhookPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/sessions/{sessionId}/chatwoot/auto-create-inbox": {
            "post": {
        ...
        "/sessions/{sessionId}/chatwoot/stats": {
            "get": {
        ...
        "/sessions/{sessionId}/chatwoot/test": {
            "post": {
    ...
    "definitions": {
        ...
        "internal_adapters_server_handler.ChatwootAccount": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "internal_adapters_server_handler.ChatwootContact": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "internal_adapters_server_handler.ChatwootConversation": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "internal_adapters_server_handler.ChatwootInbox": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "internal_adapters_server_handler.ChatwootMessage": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
        ...
        "internal_adapters_server_handler.ChatwootWebhookPayload": {
            "type": "object",
            "properties": {
                "account": {
                    "$ref": "#/definitions/internal_adapters_server_handler.ChatwootAccount"
                },
                "contact": {
                    "$ref": "#/definitions/internal_adapters_server_handler.ChatwootContact"
                },
                "conversation": {
                    "$ref": "#/definitions/internal_adapters_server_handler.ChatwootConversation"
                },
                "event": {
                    "type": "string"
                },
                "inbox": {
                    "$ref": "#/definitions/internal_adapters_server_handler.ChatwootInbox"
                },
                "message": {
                    "$ref": "#/definitions/internal_adapters_server_handler.ChatwootMessage"
                }
            }
        },
